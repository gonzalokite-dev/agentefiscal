    ...
    >
      ...
      >
        ...
        <h2
          ...
          style={{ fontSize: '18px', color: '#002A3A', lineHeight: 1.35 }}
        >
          {post.title}
        </h2>
        ...
        <div className="flex items-center justify-between">
          ...
          <span
            ...
            style={{ fontSize: '13px', color: '#EAAA00' }}
          >
            Leer
...
function EmptyState() {
  return (
    ...
    >
      ...
      >
        <svg width="24" height="24" fill="none" stroke="#EAAA00" strokeWidth="1.5" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
        </svg>
      </div>
      <h3 className="font-sans font-bold mb-2" style={{ fontSize: '18px', color: '#002A3A' }}>
